...
<script language=JavaScript>
	...
	function clearCart() {
		var confirmFlag=window.alert("确认清空购物车？");
										...
										<td>
											<form action="#" method="post" name="myform">
												<table>
													<tr>
														<td>
															<p style="font-size: 15px;font-weight: lighter">备注</p>
														</td>
													</tr>
													<tr>
														<td>
															<textarea rows="7" cols="35" id="orderTemp" ></textarea>
														</td>
